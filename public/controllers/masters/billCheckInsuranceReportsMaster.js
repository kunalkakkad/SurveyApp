    ...
    $scope.billCheckReportsTableGridOptions = {
        ...
        onRegisterApi: function(gridApi) {
            ...
            gridApi.selection.on.rowSelectionChanged($scope,function(row){
                ...
                //06.10.17
                //The data from these variables won't be modified in this form, so no point changing their structure to use them
...
//                            console.log('True');
                ...
                BLCHKData.billCheckRetriever($rootScope.billCheckReport.Main._id)
                	.then(function(response){
                        ...
                        $rootScope.billCheckReport.billCheckParts = angular.copy(response.data.surveyBillCheckPart);
